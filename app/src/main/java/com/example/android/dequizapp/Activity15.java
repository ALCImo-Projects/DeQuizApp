...
public class Activity15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(TotalQuestion>=10){
            Intent intent = new Intent(Activity15.this, Submit.class);
    ...
    public void isAnswer(){
        ...
        if(rb.isChecked()){
            gotIt=gotIt+1;
            Toast toast = new Toast(Activity15.this);
            View view1 =getLayoutInflater().inflate(R.layout.correct6,(ViewGroup)findViewById(R.id.toastView));
            toast.setView(view1);
            toast.show();
            ...
            Toast toast = new Toast(Activity15.this);
            View view1 =getLayoutInflater().inflate(R.layout.fail4,(ViewGroup)findViewById(R.id.toastView));
            toast.setView(view1);
            toast.show();
            toast.setDuration(Toast.LENGTH_SHORT);
        }
    ...
    public void showTimer(){
        ...
        new CountDownTimer(totalTime,1000){
            ...
            public void onTick(long l) {
                TextView tv = (TextView)findViewById(R.id.timer15);
